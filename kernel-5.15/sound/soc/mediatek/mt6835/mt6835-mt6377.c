...
/*
 *  mt6835-mt6377.c  --  mt6835 mt6377 ALSA SoC machine driver
 *
...
#include "../../codecs/bigdata_cs35l43_sysfs_cb.h"
#endif
 ...
 * BE i2s need assign snd_soc_ops = mt6835_mt6377_i2s_ops
 */
static int mt6835_mt6377_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6835_mt6377_i2s_ops = {
	.hw_params = mt6835_mt6377_i2s_hw_params,
};

#if IS_ENABLED(CONFIG_SND_SOC_CS35L43)
static int cs35l43_i2s3_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	if (component && strstr(component->name, "cs35l43"))
...
static int mt6835_mt6377_cs35l43_hw_params(struct snd_pcm_substream *substream,
					struct snd_pcm_hw_params *params)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	unsigned int rate = params_rate(params);
...
static const struct snd_soc_ops mt6835_mt6377_cs35l43_ops = {
	.hw_params = mt6835_mt6377_cs35l43_hw_params,
};
#endif

static int mt6835_mt6377_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	struct snd_soc_component *codec_component =
		snd_soc_rtdcom_lookup(rtd, CODEC_MT6377_NAME);
	int phase;
	...
	mt6377_mtkaif_calibration_enable(codec_component);
	...
	for (phase = 0;
	     ...
	     mtkaif_calib_ok;
	     phase++) {
		mt6377_set_mtkaif_calibration_phase(codec_component,
						    phase, phase, phase);
	...
	mt6377_mtkaif_calibration_disable(codec_component);
...
static int mt6835_mt6377_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	mt6377_set_codec_ops(codec_component, &ops);

	/* set mtkaif protocol */
	mt6377_set_mtkaif_protocol(codec_component,
				   MTKAIF_PROTOCOL_2_CLK_P2);
	afe_priv->mtkaif_protocol = MTKAIF_PROTOCOL_2_CLK_P2;

	/* mtkaif calibration */
	mt6835_mt6377_mtkaif_calibration(rtd);
...
static int mt6835_mt6377_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6835_mt6377_vow_hardware);
...
static void mt6835_mt6377_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
...
static const struct snd_soc_ops mt6835_mt6377_vow_ops = {
	.startup = mt6835_mt6377_vow_startup,
	.shutdown = mt6835_mt6377_vow_shutdown,
};
...
static struct snd_soc_dai_link mt6835_mt6377_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
...
#if IS_ENABLED(CONFIG_SND_SOC_CS35L43)
		.ops = &mt6835_mt6377_cs35l43_ops,
#else
		.ops = &mt6835_mt6377_i2s_ops,
#endif
		.no_pcm = 1,
		.dpcm_capture = 1,
		.ignore_suspend = 1,
...
static struct snd_soc_card mt6835_mt6377_soc_card = {
	.name = "mt6835-mt6377",
	.owner = THIS_MODULE,
	.dai_link = mt6835_mt6377_dai_links,
	.num_links = ARRAY_SIZE(mt6835_mt6377_dai_links),

	.controls = mt6835_mt6377_controls,
	.num_controls = ARRAY_SIZE(mt6835_mt6377_controls),
	.dapm_widgets = mt6835_mt6377_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6835_mt6377_widgets),
	.dapm_routes = mt6835_mt6377_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6835_mt6377_routes),
};
...
static int mt6835_mt6377_dev_probe(struct platform_device *pdev)
{
...
static const struct of_device_id mt6835_mt6377_dt_match[] = {
	{.compatible = "mediatek,mt6835-mt6377-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6835_mt6377_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6835_mt6377_driver = {
	.driver = {
		.name = "mt6835-mt6377",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6835_mt6377_dt_match,
#endif
		.pm = &mt6835_mt6377_pm_ops,
	},
	.probe = mt6835_mt6377_dev_probe,
};

module_platform_driver(mt6835_mt6377_driver);

/* Module information */
MODULE_DESCRIPTION("MT6835 mt6377 ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6835 mt6377 soc card");
