...
#define GLOBAL_IMMUTABLE_ROOT_STATUS		(FEATURE_IMMUTABLE_ROOT \
						| FEATURE_IMMUTABLE_ROOT_SOFT)
#else
#define GLOBAL_IMMUTABLE_ROOT_STATUS		FEATURE_IMMUTABLE_ROOT
#endif
...
#if (defined(DEFEX_PED_ENABLE) || defined(DEFEX_SAFEPLACE_ENABLE) \
	|| defined(DEFEX_TRUSTED_MAP_ENABLE) || defined(DEFEX_IMMUTABLE_ENABLE))
#define DEFEX_FEATURE_ENABLE
#endif /* DEFEX_PED_ENABLE || DEFEX_SAFEPLACE_ENABLE ||
	* DEFEX_TRUSTED_MAP_ENABLE || DEFEX_IMMUTABLE_ENABLE
	*/
