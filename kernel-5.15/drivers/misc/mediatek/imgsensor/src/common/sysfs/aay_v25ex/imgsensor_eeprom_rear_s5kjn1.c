...
#define REAR_S5KJN1_MAX_CAL_SIZE               (0x3D39 + 0x1) //actual size of cal

#define REAR_S5KJN1_HEADER_CHECKSUM_LEN        (0x00FB - 0x0000 + 0x1)
#define REAR_S5KJN1_OEM_CHECKSUM_LEN           (0x2ECB - 0x2E80 + 0x1)
#define REAR_S5KJN1_AWB_CHECKSUM_LEN           (0x36EB - 0x36E0 + 0x1)
#define REAR_S5KJN1_SHADING_CHECKSUM_LEN       (0x3E4B - 0x36F0 + 0x1)
...
#define REAR_S5KJN1_CONVERTED_MAX_CAL_SIZE     (0x4089 + 0x1 + 0x10) //margin(0x10) of cal conversion
...
const struct imgsensor_vendor_rom_addr rear_s5kjn1_cal_addr = {
	...
	.rom_pdaf_module_info_start_addr        = 0x2ED0,
