 ...
 *
 ****************************************************************************/
#ifndef _S5KJN1MIPI_SENSOR_H
#define _S5KJN1MIPI_SENSOR_H

// if you want to use implant mode without tail data(PDAF data), use below define.
//#define PDAF_DISABLE

#if IS_ENABLED(CONFIG_CAMERA_XXX_V07) || IS_ENABLED(CONFIG_CAMERA_AAX_V15X) || IS_ENABLED(CONFIG_CAMERA_AAX_V15) || IS_ENABLED(CONFIG_CAMERA_AAY_V25EX)
