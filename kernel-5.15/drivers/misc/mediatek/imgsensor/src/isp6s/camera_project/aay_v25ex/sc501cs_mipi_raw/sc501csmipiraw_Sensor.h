...
/* OTP */
#define VALID_BANK_MARK              0x55

#define SC501CS_OTP_BANK1_MARK       0x01
#define SC501CS_OTP_BANK2_MARK       0x03

#define SC501CS_FIRST_OTP_ADDR       0x8000
#define SC501CS_SECOND_OTP_ADDR      0x8800

#define SC501CS_OTP_BANK1_START_ADDR 0x80EC
#define SC501CS_OTP_BANK2_START_ADDR 0x8870
