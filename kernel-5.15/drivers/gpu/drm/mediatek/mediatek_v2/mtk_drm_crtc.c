...
#if defined(CONFIG_MT_ENG_BUILD) || IS_ENABLED(CONFIG_DRM_PANEL_MCD_COMMON)
...
#if IS_ENABLED(CONFIG_DRM_PANEL_MCD_COMMON) && !IS_ENABLED(CONFIG_SEC_FACTORY) && !defined(CONFIG_SAMSUNG_PRODUCT_SHIP)
	BUG();
#endif
}
