...
static struct vb2_mem_ops jpeg_enc_dma_contig_memops;
			       ...
			       struct vb2_queue *dst_vq)
{
	...
	jpeg_enc_dma_contig_memops = vb2_dma_contig_memops;
	jpeg_enc_dma_contig_memops.mmap = NULL;
	src_vq->mem_ops = &jpeg_enc_dma_contig_memops;
	...
	dst_vq->mem_ops = &jpeg_enc_dma_contig_memops;
