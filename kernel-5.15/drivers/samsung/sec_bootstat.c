...
/**************************************************************
 * bootingtime_preloader & bootingtime_lk should be defined at 
 * drivers/misc/mediatek/mtprof/bootprof.c.
 *************************************************************/
extern int bootingtime_preloader;
extern int bootingtime_lk;
...
int sec_bootstat_init(void)
{
	...
	register_hook_bootstat(sec_boot_stat_add);

	return 0;
}
EXPORT_SYMBOL(sec_bootstat_init);
