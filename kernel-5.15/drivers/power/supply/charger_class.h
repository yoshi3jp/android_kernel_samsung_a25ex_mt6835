...
struct charger_ops {
	...
	/* AFC support */
	int (*send_afc_data)(struct charger_device *dev, u32 val);
	int (*set_afc_voltage)(struct charger_device *dev, int val);
	int (*afc_disable_set)(struct charger_device *dev, int val);

	/* HICCUP */
	int (*set_enable_hiccup)(struct charger_device *dev, bool en);	
	int (*set_cc_hi_state)(struct charger_device *dev, int val);	

	/* Water detection */
	int (*set_water_state)(struct charger_device *dev, bool val);	
	...
	int (*get_vbus_level)(struct charger_device *dev, int *vbus);
	...
	int (*set_vsysmin)(struct charger_device *dev, unsigned int mV);
...
extern int charger_dev_enable_6pin_battery_charging(
	struct charger_device *charger_dev, bool en);
extern int charger_dev_send_afc_data(
	struct charger_device *chg_dev, u32 val);
extern int charger_dev_afc_set_voltage(
	struct charger_device *chg_dev, int val);
extern int charger_dev_afc_disable_set(
	struct charger_device *chg_dev, int val);
extern int charger_dev_enable_hiccup(
	struct charger_device *chg_dev, bool en);
extern int charger_dev_set_cc_hi_state(
	struct charger_device *chg_dev, int val);
extern int charger_dev_set_water_state(
	struct charger_device *chg_dev, bool val);
...
extern int charger_dev_enable_ship_mode(struct charger_device *charger_dev, bool batdet_dis_dly);
extern int charger_dev_get_vsys(struct charger_device *charger_dev,
	u32 *vsys);
extern int charger_dev_enable_aicc(struct charger_device *charger_dev, bool en);
extern int charger_dev_get_charging_status(struct charger_device *charger_dev,
					u32 *charging_status);
extern int charger_dev_en_wdt(struct charger_device *charger_dev, bool en);
extern int charger_dev_en_ilim(struct charger_device *charger_dev, bool en);
extern int charger_dev_set_vsysmin(
	struct charger_device *charger_dev, unsigned int mV);
...
extern int charger_dev_get_vbus_level(
	struct charger_device *chg_dev, int *vbus);
...
extern int charger_dev_get_health(struct charger_device *charger_dev, int *health);
extern int charger_dev_get_charge_type(struct charger_device *charger_dev, int *type);
