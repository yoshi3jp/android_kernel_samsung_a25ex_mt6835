...
struct pe50_algo_data {
	...
	int cv_input_current_limit;
	int step_count_timer1;
	int step_count_timer2;
#endif
	int cv_limit;
	bool is_ita_limit_stop;
	bool disable_quick_charge;
	bool is_wakeup_timer;
	enum wt_charging_state wt_charging_state;
};
