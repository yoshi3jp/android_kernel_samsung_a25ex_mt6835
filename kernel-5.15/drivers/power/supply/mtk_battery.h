...
enum hv_charger_status {
	NORMAL_TA,
	AFC_9V_OR_15W,    /* over 12W */
	AFC_12V_OR_20W,   /* currently unused */
	SFC_25W,          /* over 24.5W */
	SFC_45W,
	HV_STATUS_MAX,
};
...
enum online_type {
	NO_IMPLEMENT = 0,     /* no standard insert*/
	NO_ADAPTER_TYPE = 1,
	AC_ADAPTER_TYPE = 3,  /* ac */
	USB_CDP_TYPE = 4,     /* usb cdp */
	ONLINE_TYPE_MAX,
};

enum sec_bat_current_event {
	SEC_BAT_CURRENT_EVENT_NONE = 0,
	SEC_BAT_CURRENT_EVENT_FAST = BIT(0),
	SEC_BAT_CURRENT_EVENT_CHARGE_DISABLE = BIT(1),
	SEC_BAT_CURRENT_EVENT_LOW_TEMP_SWELLING = BIT(4),
	SEC_BAT_CURRENT_EVENT_HIGH_TEMP_SWELLING = BIT(5),
	SEC_BAT_CURRENT_EVENT_USB_100MA = BIT(6),
	SEC_BAT_CURRENT_EVENT_SLATE = BIT(11),
	SEC_BAT_CURRENT_EVENT_HV_DISABLE = BIT(16),
};
...
#define AVGVBAT_ARRAY_SIZE 5 /* ALPS07387291 reduce avg size for fast shutdown tracking */
#define INIT_VOLTAGE 3450
#define BATTERY_SHUTDOWN_TEMPERATURE 68// 60
