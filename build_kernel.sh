...
cd kernel-5.15
python scripts/gen_build_config.py --kernel-defconfig a25ex_00_defconfig --kernel-defconfig-overlays "entry_level.config" -m user -o ../out/target/product/a25ex/obj/KERNEL_OBJ/build.config
